...
erl -sname "$short_name" -setcookie "$erlang_cookie" -hidden -remsh $remote_node -pa $HOME/dotfiles/erlang/ -eval 'patch_remote:with_module(user_default, init:get_arguments()).'
